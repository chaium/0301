...
export function u(dis, tin, vel) {
 return 0.0354 * Math.sqrt(A0) * Ar0(tin,vel) * Math.pow((dis/Math.sqrt(A0)),3) * Math.sqrt(T0/Tback(tin)) + 0.114 * dis;
 }

export function c(dis, tin, vel) {
 return 0.0354 * Math.sqrt(A0) * Ar0(tin,vel) * Math.pow((dis/Math.sqrt(A0)),3) * Math.sqrt(T0/Tback(tin));
}
